module.exports = (img,cotizacion,companias,pcob,cobp,pcla,clap,tsa,modelo,mim) => {
 ...
 compania += "<tr>"; 
 compania += "<td width='20%' class='cobe'>";
 compania += `<img src="${mim+modelo}" border="0" alt="logo" width="80" height="40">`;
 compania += "</td>"	
 for(var i in companias){           
    compania += td+`<img src="${img+companias[i].Companium.filename}" border="0" alt="logo" width="80" height="40">`+"</td>";        
        ...
        <div class="cliente">                   
          <table class="table-datos">
            <tr>
              ...
              <td width="20%">${cotizacion.nombre}</td>            
              <td width="10%"><b>Email :</b></td>                            
              <td width="20%">${cotizacion.email}</td>            
